...
namespace Microsoft.WindowsAPICodePack.Dialogs
{
    ...
    public sealed class TaskDialog : IDialogControlHost, IDisposable
    {
        ...
        private void ApplyGeneralNativeConfiguration(TaskDialogNativeMethods.TaskDialogConfiguration dialogConfig)
        {
            ...
            dialogConfig.mainIcon = (IntPtr)icon;// new TaskDialogNativeMethods.IconUnion((int)icon);
            dialogConfig.footerIcon = (IntPtr)footerIcon; // new TaskDialogNativeMethods.IconUnion((int)footerIcon);
